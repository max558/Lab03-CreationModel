...
namespace RevitAPITreningLibrary
{
    public class SelectionUtils
    {
         ...
         */
        public static List<T> SelectAllElement<T>(ExternalCommandData commandData)
        {
         ...
         * Вывод: список элементов
         */
        public static List<T> SelectAllElementActiveDoc<T>(ExternalCommandData commandData, ElementId viewId = null)
        {
            UIApplication uiapp = commandData.Application;
            UIDocument uidoc = uiapp.ActiveUIDocument;
            Document doc = uidoc.Document;
         ...
         */
        public static List<T> SelectAllElementCategory<T>(ExternalCommandData commandData, BuiltInCategory builtInCategory)
        {
            UIApplication uiapp = commandData.Application;
            UIDocument uidoc = uiapp.ActiveUIDocument;
            Document doc = uidoc.Document;
         ...
         */
        public static List<T> SelectAllElementCategoryType<T>(ExternalCommandData commandData, BuiltInCategory builtInCategory)
        {
            UIApplication uiapp = commandData.Application;
            UIDocument uidoc = uiapp.ActiveUIDocument;
            Document doc = uidoc.Document;
